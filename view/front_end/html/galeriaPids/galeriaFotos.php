    ...
    <div class="geral">
        ...
        <div class="container">
            ...
            <div class="conteudo">
                ...
                $dao = new receitaDAO();
                $lista = $dao->list();//executando lista.
                foreach ($lista as $value) {//pegar a 
                //lista e transformar em objetos
            ?>
            <tr>
        ...
        <button style="float: right" name="btncadreceita" onclick="location.href='cadreceita.php'">Cadastrar receita</button>
      </div>
    </div>
    <div class="rodape">
